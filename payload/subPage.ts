...
export async function subNumber(request: APIRequestContext, A: number, B: number) {
    ...
    return `<SubtractResponse><SubtractResult>${difference}</SubtractResult></SubtractResponse>`;
}
